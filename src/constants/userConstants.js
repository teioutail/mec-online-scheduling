...
export const USER_SE_LIST_REQUEST = 'USER_SE_LIST_REQUEST'
export const USER_SE_LIST_SUCCESS = 'USER_SE_LIST_SUCCESS'
export const USER_SE_LIST_FAIL = 'USER_SE_LIST_FAIL'
export const USER_SE_LIST_RESET = 'USER_SE_LIST_RESET'